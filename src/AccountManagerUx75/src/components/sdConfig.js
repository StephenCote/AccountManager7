/**
 * sdConfig.js — Common SD config utility for olio.sd.config model (ESM)
 * Port of Ux7 client/components/sdConfig.js
 *
 * Provides shared functions for fetching templates, loading/saving configs,
 * building entities, and filling style defaults.
 */
...
// ── Fallback data for style-specific fields ──
const SD_FALLBACKS = {
