 ...
 * ESM port of Ux7 client/view/cardGame/constants/gameConstants.js
 *
...
// Late-bound accessors for page and client
 ...
 * on the exported gameConstants object. Falls back to hardcoded defaults.
 */
async function loadActionDefinitions() {
    try {
        ...
        if (data && data.actions) {
            ...
            gameConstants.ACTION_DEFINITIONS = ACTION_DEFINITIONS;
        ...
        if (data && data.commonActions) {
            ...
            gameConstants.COMMON_ACTIONS = COMMON_ACTIONS;
        }
        ...
        gameConstants.ACTION_ART_PROMPTS = ACTION_ART_PROMPTS;
    } catch (e) {
...
// ── Expose as gameConstants object ────────────────────────────────
const gameConstants = {
    CARD_TYPES,
    TEMPLATE_TYPES,
    ITEM_SUBTYPE_ICONS,
...
console.log('[CardGame] Constants loaded (' + Object.keys(gameConstants).length + ' exports)');
