/**
 * CardGame Designer — Layout Configuration (ESM)
 ...
 * Each card type x card size combination gets its own layout config.
 * Screen display contexts (standard/compact/mini/full) also have layouts.
 *
 * Ported from Ux7 IIFE to ESM.
 *
 * Depends on: gameConstants (CARD_TYPES, CARD_RENDER_CONFIG, CARD_SIZES, LAYOUT_ZONES)
 */
...
console.log("[CardGame] Designer.LayoutConfig loaded (ESM)");
