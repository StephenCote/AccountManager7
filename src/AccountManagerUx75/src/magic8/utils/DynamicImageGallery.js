 ...
 *
 * ESM port of AccountManagerUx7/client/view/magic8/utils/DynamicImageGallery.js
 */
        ...
        try {
            ...
            if (allResults.length > 0) {
                this.baseImages = allResults
                    ...
                    .map(r => ({
                        url: `${appBase}/media/Public/data.data${encodeURI(r.groupPath)}/${encodeURIComponent(r.name)}`,
                        objectId: r.objectId,
                        type: 'base',
                        name: r.name
                    }));
...
const Magic8DynamicImageGallery = { DynamicImageGallery };

export { DynamicImageGallery };
export default Magic8DynamicImageGallery;
