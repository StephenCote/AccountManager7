 ...
 *
 * ESM port of AccountManagerUx7/client/view/magic8/components/HypnoCanvas.js
 */
...
const HypnoCanvas = {
     ...
     * producing the moire spiral illusion from the reference spiral.html/css.
 ...
 * @returns {Object} Fresh HypnoCanvas instance
 */
...
const Magic8HypnoCanvas = { HypnoCanvas, createHypnoCanvas };

export { HypnoCanvas, createHypnoCanvas };
export default Magic8HypnoCanvas;
