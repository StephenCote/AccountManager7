 ...
 * Animation types: drift, pulse, scale, float, glow, breathe, swell
...
const BiometricOverlay = {
    ...
    view(vnode) {
        ...
        return m('.absolute.inset-0.pointer-events-none.overflow-hidden', {
            ...
            return m('div', { key: label.id, style: style }, label.text);
        }));
    }
};
