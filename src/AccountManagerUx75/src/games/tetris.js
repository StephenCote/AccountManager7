...
function refreshGrid(){
    ...
    let gridStyle = "display:flex;flex-wrap:wrap;width: " + (data.grid_width * w) + "px";
    let previewStyle = "display:flex;flex-wrap:wrap;width: " + (data.piece_width * w) + "px";
    ...
    if(preview){
        ...
        prev = m("div", {style: previewStyle}, prevGrid);
    }
    return [m("div", {style: gridStyle}, gridView), prev];
}
...
function modelPanel(){
    const page = getPage();
    return [m("div",{class: "overflow-auto"},
                m("div",{class: "bg-white dark:bg-gray-800 rounded-lg shadow p-4"},
                    m("p", {"class" : "text-lg font-semibold mb-2 flex items-center"}, [
                        m("span", {class : "material-symbols-outlined mr-2"}, icon),
                        label
                    ]),
                    m("div", {"class": "p-2"}, modelGame())
                )
        ),
        m("div",{class: "fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-2"},[
            m("div",{class: "flex justify-center items-center gap-2"},[
                m("div",{class: "flex gap-1"},[
                    page.iconButton("p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700", "undo", "", rotateLeft),
                    page.iconButton("p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700", "west", "", moveLeft),
                    page.iconButton("p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700", "south", "", drop),
                    page.iconButton("p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700", "east", "", moveRight),
                    page.iconButton("p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700", "redo", "", rotateRight)
                ])
            ])
        ]),
    ];
...
function getScoreCard(){
    const page = getPage();
    return m("div",{class: "bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-2"},[
        m("div",{class: "flex justify-center items-center gap-4"},[
            page.iconButton("p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700", "start", "", start),
            m("div",{class: "text-sm font-medium text-gray-700 dark:text-gray-300"},"Level " + (data ? data.level : 1)),
            m("div",{class: "text-sm font-medium text-gray-700 dark:text-gray-300"},"Score " + (data ? data.score : 0)),
            page.iconButton("p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700", "stop", "", stop)
        ])
    ]);
}
