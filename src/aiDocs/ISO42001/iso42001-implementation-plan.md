...
**Judgment calls flagged (⚠):**
- **BIAS-NARR has no module in `iso42001-bias.md`** (only design §5.1 describes it conceptually). Asked Stephen; per his call it runs the fully-specified **BIAS-EDU-003** recommendation-letter test by default, with HR-001/RE-001 variants selectable via `NarrModule(Variant)` so a user/group can pick — no bias content invented.
