...
public class OlioModelNames extends ModelNames {
	...
	public static final String MODEL_CONNECTION = "olio.llm.connection";
	...
	public static final String MODEL_CONTEXT_REF = "olio.llm.contextRef";
	...
	public static List<String> MODELS = Arrays.asList(
		...
		MODEL_NARRATIVE, MODEL_CHAT_CONFIG, MODEL_CONNECTION, MODEL_PROMPT_CONFIG, MODEL_PROMPT_RACE_CONFIG, MODEL_PROMPT_TEMPLATE, MODEL_PROMPT_SECTION, MODEL_POI, MODEL_WORLD, MODEL_EPISODE, MODEL_SD_CONFIG, MODEL_SD_CONFIG_DATA,
		MODEL_VECTOR_CHAT_HISTORY, MODEL_VECTOR_CHAT_HISTORY_LIST, MODEL_CHAT_OPTIONS, MODEL_CHAT_REQUEST, MODEL_CHAT_RESPONSE, MODEL_CHAT_MESSAGE, MODEL_CONTEXT_REF, MODEL_SESSION_CONTEXT, MODEL_CONTEXT_RESULT,
