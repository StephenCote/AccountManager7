...
public class OlioModelNames extends ModelNames {
	...
	public static List<String> MODELS = Arrays.asList(
		...
		MODEL_OPENAI_MESSAGE, MODEL_OPENAI_REQUEST, MODEL_OPENAI_RESPONSE, MODEL_OPENAI_CHOICE, MODEL_OPENAI_CONTEXT, MODEL_OPENAI_CITATION, MODEL_OPENAI_USAGE, MODEL_OPENAI_FILTER_RESULT, MODEL_OPENAI_FILTER_RESULTS 
	);
