...
public class ChatBAK {
	...
	public static final Logger logger = LogManager.getLogger(ChatBAK.class);
...
""";
	...
	public ChatBAK(BaseRecord user) {
		this.user = user;
	}
	...
	*/
	...
	public OllamaRequest getChatPrompt(OlioContext octx, String defPrompt, String iPrompt, BaseRecord epoch, BaseRecord evt, BaseRecord systemChar, BaseRecord userChar, BaseRecord interaction, boolean rpg) {
		...
		if(systemChar != null && userChar != null) {
			...
			String sysTemp = getSystemChatPromptTemplate(octx, epoch, evt, systemChar, userChar, interaction, iPrompt);
			String userTemp = getUserChatPromptTemplate(octx, epoch, evt, systemChar, userChar, interaction, iPrompt);
