...
public class ModelNames {
	...
	public static List<String> MODELS = Arrays.asList(
		...
		MODEL_LOCATION, MODEL_GEO_LOCATION, MODEL_WORLD, MODEL_CHAR_PERSON, MODEL_INSTINCT, MODEL_PERSONALITY, MODEL_PERSONALITY_TRAIT, MODEL_SOCIAL_BEHAVIOR,
		...
		MODEL_ACTION, MODEL_ACTION_RESULT, MODEL_SCHEDULE, MODEL_INVENTORY_ENTRY, MODEL_STORE, MODEL_BUILDER, MODEL_ITEM_STATISTICS, MODEL_ANIMAL, MODEL_REALM, MODEL_INTERACTION
	);
