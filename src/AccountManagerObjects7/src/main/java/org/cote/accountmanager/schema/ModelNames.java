...
public class ModelNames {
	...
	public static List<String> MODELS = Arrays.asList(
		...
		MODEL_FUNCTION, MODEL_TAG, MODEL_MODEL_CATEGORY, MODEL_NOTE, MODEL_SOCKET_MESSAGE, MODEL_FIELD_LOCK, MODEL_TRAIT, MODEL_WORD, MODEL_WORD_NET, MODEL_WORD_NET_POINTER, MODEL_WORD_NET_ALT,
		MODEL_LOCATION, MODEL_GEO_LOCATION
	);
