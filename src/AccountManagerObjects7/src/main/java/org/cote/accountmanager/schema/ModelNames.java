...
public class ModelNames {
	...
	public static final String MODEL_WEBAUTHN_CREDENTIAL = "auth.webauthnCredential";
	...
	public static final String MODEL_PAGE_INDEX = "data.pageIndex";
	public static final String MODEL_PAGE_INDEX_NODE = "data.pageIndexNode";

	public static final String MODEL_GROUP_EXPORT = "data.groupExport";
	...
	public static final String MODEL_CONNECTION = "system.connection";
	...
	public static final String MODEL_MEMORY = "tool.memory";
	public static final String MODEL_VECTOR_MEMORY = "tool.vectorMemory";
	public static final String MODEL_VECTOR_MEMORY_LIST = "tool.vectorMemoryList";
	...
	public static List<String> MODELS = Arrays.asList(
		...
		MODEL_INDEX2, MODEL_INDEX_ENTRY2, MODEL_INDEX_ENTRY_VALUE2, MODEL_INDEX_STORE, MODEL_KEY_STORE, MODEL_VAULT, MODEL_AUTHENTICATION_REQUEST, MODEL_AUTHENTICATION_RESPONSE, MODEL_WEBAUTHN_CREDENTIAL,
		...
		MODEL_TASK_REQUEST, MODEL_TASK_RESPONSE, MODEL_PLAN, MODEL_PLAN_STEP, MODEL_CHAIN_EVENT, MODEL_MEMORY, MODEL_VECTOR_MEMORY, MODEL_VECTOR_MEMORY_LIST, MODEL_VOICE, MODEL_CONNECTION,
		MODEL_PAGE_INDEX, MODEL_PAGE_INDEX_NODE, MODEL_GROUP_EXPORT
