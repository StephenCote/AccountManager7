...
public class ModelNames {
	...
	public static List<String> MODELS = Arrays.asList(
		...
		MODEL_TASK_REQUEST, MODEL_TASK_RESPONSE, MODEL_PLAN, MODEL_PLAN_STEP, MODEL_CHAIN_EVENT, MODEL_MEMORY, MODEL_VECTOR_MEMORY, MODEL_VECTOR_MEMORY_LIST, MODEL_VOICE
