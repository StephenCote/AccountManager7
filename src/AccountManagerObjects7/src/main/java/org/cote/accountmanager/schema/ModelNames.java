...
public class ModelNames {
	...
	public static List<String> MODELS = Arrays.asList(
		...
		MODEL_LOCATION, MODEL_GEO_LOCATION,  MODEL_PERSONALITY, MODEL_SOCIAL_BEHAVIOR,MODEL_COLOR, MODEL_SOCIAL_GROUP, MODEL_BEHAVIOR, MODEL_PROFILE, MODEL_VECTOR_MODEL_STORE
