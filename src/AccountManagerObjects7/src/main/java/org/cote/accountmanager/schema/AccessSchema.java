...
public class AccessSchema {
	...
	public static final String ROLE_REQUEST_UPDATERS = "RequestUpdaters";
	...
	public static final String[] SYSTEM_ROLE_NAMES = new String[]{
		...
		ROLE_APPROVERS, ROLE_REQUESTERS, ROLE_REQUEST_READERS, ROLE_REQUEST_UPDATERS, ROLE_REQUEST_ADMINISTRATORS
	};
	...
	public static final String SYSTEM_PERMISSION_AUTHENTICATE = "Authenticate";
	
	public static final String[] SYSTEM_PERMISSION_NAMES = new String[] {
		SYSTEM_PERMISSION_CREATE, SYSTEM_PERMISSION_READ, SYSTEM_PERMISSION_UPDATE, SYSTEM_PERMISSION_DELETE, SYSTEM_PERMISSION_EXECUTE, SYSTEM_PERMISSION_AUTHENTICATE
	};
