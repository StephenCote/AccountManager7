(function(){
    ...
    function navigable(){
        let nav = {
            ...
            removeContextMenu : function(menuPath){
                ...
                // console.log("Cleanup " + menuPath + " = " + (this.contextMenus.length < len));
            },
            /*
            contextMenuButton2: function(sLabel, sIco, fHandler){
                return m("button",{class : "context-menu-item", onclick : function(){page.navigable.menu(".context-menu");if(fHandler) fHandler();}},[(sLabel || ""), (sIco ? m("span",{class : "material-icons material-icons-cm ml-2"},sIco) : "")]);
            },
            */
            contextMenuButton: function(sMenuId, sLabel, sIco, fHandler){
                ...
                //console.log(id);
                return m("button",{class : "context-menu-item", onclick : 
                    function(){
            ...
            setupPendingContextMenus : function(){
                // console.log("Create menus ... " + navg.pendingMenus.length);
            ...
            menu : function(path, bF, bN){
                this.contextMenus.forEach((m)=>{
                    //console.log(m.menuPath + " == " + path + " / " + bN + " / " + (!path || m.menuPath === path) + " / " + (path && !bF && !m.menuOpen) );
                    //if(!path || m.menuPath === path) m.menuOpen = (path && !bF && !m.menuOpen) || false;
                    m.menuOpen = (
    ...
    navigation.view = {
        onupdate : function(x){
           //  console.log(x.attrs.communityId);
        },
        oninit : function(x){
           //  console.log(x.attrs.communityId);
