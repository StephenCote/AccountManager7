    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        if request.voice_sample:
            try:
                ...
                input_audio = AudioSegment.from_file(io.BytesIO(audio_bytes))
                
                # Export explicitly as a compliant WAV file
                input_audio.export(speaker_wav_path, format="wav")
        ...
        for i, sentence in enumerate(sentences):
            ...
            try:
                ...
                print("XTTS internal error:", e)
                raise
            print("file exists:", os.path.exists(chunk_file))
            print("file size:", os.path.getsize(chunk_file))
