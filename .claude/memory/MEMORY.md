...
- `project-pb5-phase-status` -- Phase 5a Playwright gate closed (6/6 tests pass); Phase 5b Mithril UI implementation complete — code, build, and Vitest green; Playwright E2E not yet written
